...
export const projectData: Project[] = [
    {
        ...
        tools:"NextJs, Mui, Framer Motion, Firebase, Vercel",
    ...
    },
    {
        id:"3",
        title:"BBQ Recipes",
        description:"BBQ Master is a mobile application who helps people to discover authentic Argentine BBQ recipes and grilling like a true barbecue enthusiast.",
    ...
    },
    {
        id:"4",
        title:"Cod Counter",
        description:"Cod Counter is the ultimate platform to track and compare stats among friends.",
